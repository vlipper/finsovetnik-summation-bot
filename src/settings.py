...
Часто заметка может быть неполной или ссылаться на информацию, которой у тебя нет. Ты должен игнорировать эту неполноту или сообщить, если считаешь что недостающая информация критически важна.
""".strip()
